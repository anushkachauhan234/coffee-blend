...
// If subtotal is 0, all charges and total are 0
if ($subtotal == 0) {
    $delivery = 0;
    $delivery_text = "₹0";
    $discount = 0;
  ...
  <div class="container">
            ...
            <tbody>
              ...
              <tr class="text-center">
                <td class="product-remove">
                  <a href="delete-product.php?id=<?php echo $product->id; ?>"><span class="icon-close"></span></a>
                </td>
                <td class="image-prod">
    ...
    <div class="row justify-content-end">
      <div class="col col-lg-3 col-md-6 mt-5 cart-wrap ftco-animate">
        ...
        <?php else: ?>
        <p class="text-center text-muted mt-3">Add products to your cart to proceed to checkout.</p>
        <?php endif; ?>
